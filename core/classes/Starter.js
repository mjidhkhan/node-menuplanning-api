class Starter {
    ...
    /**
     * Get  All Veg Starters
     */
    static getVegStartersSQL() {
            let sql = `SELECT *
                    FROM meal_course
                    JOIN course_details
                    ON  meal_course.id = course_details.course_id
                    WHERE  meal_course.meal_type = 1 AND meal_course.course_type =1`;
            return sql;
        }
        /**
         * Get  All Non Veg Starters 
         */
    static getNonVegStartersSQL(id) {
        let sql = `SELECT *
                    ...
                    JOIN course_details
                    ON  meal_course.id = course_details.course_id
                    WHERE meal_course.meal_type = 2 AND meal_course.course_type =1`;
        return sql;
    }
